jack = User.create(username:'Jack', email:'jack@test.com', password: 'test123' )
...
first_fridays.user= jack



sonia = User.create(username:'Sonia', email: 'sonia@test.com', password: 'rabbit123')
